    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <main>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="td-breadcrumb-wrap ">
                                    <h2 className="td-section-page-title mb-35 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1s">Votre image, <span>notre mission </span></h2>
                                    <div className="td-service-hero-thumb-2 fix td-rounded-10 pt-105 mb-30">
                                        <img data-speed=".9" className="td-rounded-10" src={thumb_2} alt=""/>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="td-service-hero-wrap">
                                    <div className="td-service-hero-content ml-110  wow fadeInRight" data-wow-delay=".5s" data-wow-duration="1s">
                                        <p className="mb-40">Chez Soon, nous transformons l’essence de votre marque en une identité visuelle unique et mémorable. Logos, chartes graphiques, packagings, supports 
                                            marketing et visuels pour les réseaux sociaux : chaque création est pensée pour captiver votre public, renforcer la confiance et fidéliser vos clients. En collaborant étroitement avec vous, 
                                            nous faisons du design de marque un véritable levier de succès, laissant une empreinte durable et démarquant votre entreprise dans un marché concurrentiel.</p>
                                        <div className="td-service-hero-border mb-60"></div>
                                        <div className="td-about-main-feature-list">
                                            <ul>
                                                <li>Art direction</li>
                                                <li>Branding</li>
                                                <li>Chartes graphiques complètes</li>
                                                <li>User Interface Design</li>
                                                <li>Animation</li>
                                                <li>Packagings qui attirent l’œil</li>
                                    ...
                                    <div className="td-service-hero-thumb fix td-rounded-10 pt-200">
                                        <img data-speed=".9" className="td-rounded-10" src={thumb} alt=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="td-service-process-area pt-80">
                    <div className="container">
                        ...
                        <div className="row gx-0">
                            <div className="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                <div className="td-service-process-item mt-120">
                                    ...
                                    <h5 className="title mb-15">Recherches</h5>
                                    <p className="para">Design moderne et unique
                                        d’un point de vue pratique</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                                <div className="td-service-process-item">
                                    ...
                                    <h5 className="title mb-15">Mettre en œuvre</h5>
                                    <p className="para">Design moderne et unique
                                        d’un point de vue pratique</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                                <div className="td-service-process-item mt-120">
                                    <span className="icons mb-60 d-flex align-items-start justify-content-between">
                                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 className="title mb-15">Testing</h5>
                                    <p className="para">Design moderne et unique
                                        d’un point de vue pratique</p>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6  wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                                <div className="td-service-process-item">
                                    <span className="icons mb-60 d-flex align-items-start justify-content-between">
                                        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 className="title mb-15">Rendu ultime</h5>
                                    <p className="para">Modern and unique design
                        ...
                        <div className="row">
                            <div className="col-lg-10">
                                <div className="td-service-main-content mb-85">
                                    <h2 className="td-text-invert">Nous remplaçons les wireframes 
                                        peu fiables et les agences coûteuses par l’une des équipes 
                            ...
                            <div className="col-lg-8">
                                <div className="td-service-replace-content">
                                    <div className="td-service-replace-thumb mb-50">
                                        <img className="td-rounded-10" src={thumbReplace} alt=""/>
                                    </div>
                                    <div className="row">
