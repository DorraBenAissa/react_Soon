                ...
                <div className="row">
                  ...
                  >
                    <div className="td-portfolio-filter-btn text-center masonary-menu">
                      ...
                      <button data-filter=".prof">Identité visuelle</button>
                      <button data-filter=".prof1">Direction artistique</button>
                      <button data-filter=".prof1">Charte graphique</button>
                      <button data-filter=".prof2">Packaging</button>
                      <button data-filter=".prof3">Naming</button>
                    </div>
                  </div>
                </div>
                <div className="grid row">
                  <div className="col-md-6 grid-item prof prof1 mb-30">
                    <div className="td-portfolio-filter-wrapper p-relative">
                      <div className="td-portfolio-filter-thumb fix">
                        <img
                          ...
                          style={{
                            ...
                            backgroundImage:
                              "linear-gradient(to top, rgba(0,0,0,0.5) 30%, transparent 100%)",
                          }}
                          src={thumb}
                          alt="project"
                        />
                      ...
                      <div className="td-portfolio-filter-content">
                        <span className="mb-10">BRANDING & DIGITAL</span>
                        <h3 className="titles">
                  ...
                  <div className="col-md-6 grid-item prof2 prof4 mb-30">
                    <div className="td-portfolio-filter-wrapper p-relative">
                      ...
                      <div className="td-portfolio-filter-content">
                        <span className="mb-10">BRANDING & DIGITAL</span>
                        <h3 className="titles">
                          <a href="portfolio-details.html">Les Intouchables</a>
                        </h3>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 grid-item prof1 prof3 mb-30">
                    <div className="td-portfolio-filter-wrapper p-relative">
                      ...
                      <div className="td-portfolio-filter-content">
                        <span className="mb-10">PACKANING</span>
                        <h3 className="titles">
                          <a href="portfolio-details.html">Easy Garnish</a>
                        </h3>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 grid-item prof3 prof1 mb-30">
                    <div className="td-portfolio-filter-wrapper p-relative">
                      ...
                      <div className="td-portfolio-filter-content">
                        ...
                        <h3 className="titles">
                          <a href="portfolio-details.html">Montana</a>
                        </h3>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 grid-item prof2 prof4 mb-30">
                    <div className="td-portfolio-filter-wrapper p-relative">
                      ...
                      <div className="td-portfolio-filter-content">
                        ...
                        <h3 className="titles">
                          <a href="portfolio-details.html">Harmour</a>
                        </h3>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 grid-item prof prof1 mb-30">
                    <div className="td-portfolio-filter-wrapper p-relative">
                      ...
                      <div className="td-portfolio-filter-content">
                        ...
                        <h3 className="titles">
                          <a href="portfolio-details.html">Fiedunit</a>
                        </h3>
                      </div>
                    </div>
                  </div>
