            ...
            <div className="row">
              ...
              <div className="col-lg-2 col-md-6 col-sm-6">
                <div className="td-footer-widget mb-30">
                  <h3 className="td-footer-title mb-30">Accès rapide</h3>
              ...
              <div className="col-lg-3 col-md-6">
                <div className="td-footer-widget ml-80 mb-30">
                  <h3 className="td-footer-title mb-30">Autres</h3>
                  <ul className="td-footer-widget-list">
                    <li>
                      <a href="#">License</a>
                    </li>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="td-footer-widget mr-30 mb-30">
                  <h3 className="td-footer-title mb-30">Adresse</h3>
                  <a
                    className="td-footer-location mb-45 d-inline-block"
                    href="#"
                  >
                    Jazz Building, 26 avenue Hergé, 77700 Chessy – Val d'Europe
                    - France
                  </a>
